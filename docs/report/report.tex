...
\begin{document}
\mainmatter
\title{CS7IS2: Artificial Intelligence}
\subtitle{Assignment 2}
\author{Ammar Qureshi \and Keith Tunstead}

\institute{
\email{qureshm@tcd.ie}, \email{tunstek@tcd.ie}}
...
This section is optional. Either if you are writing a survey or an original report you can find relevant work that has addressed similar problems. This section can briefly introduce them with a specific emphasis on differences and similarities to the proposed approach(es).
...
If an experimental evaluation has been conducted, this section should provide the details of the evaluation. Specifically:
\begin{itemize}
